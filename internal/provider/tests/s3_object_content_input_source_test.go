		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("torque_s3_object_content_input_source.s3_bucket", "json_path", "path"),
					resource.TestCheckResourceAttr("torque_s3_object_content_input_source.s3_bucket", "json_path_overridable", "false"),
					resource.TestCheckResourceAttr("torque_s3_object_content_input_source.s3_bucket", "display_json_path", "path"),
			...
			// Update and Read testing
			{
				...
				`, unique_name, description, unique_bucket, new_credential_name, new_pattern, new_json_path, new_key, new_display_json_path),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("torque_s3_object_content_input_source.s3_bucket", "specific_spaces.0", "TorqueTerraformProvider"),
				),
			},
