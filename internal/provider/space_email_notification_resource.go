	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"environment_launched": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Launched\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_deployed": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Deployed\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_force_ended": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Force Ended\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_idle": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Idle\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_extended": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Extended\" event",
				Optional:            true,
				Computed:            false,
			},
			"drift_detected": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Drift Detected\" event",
				Optional:            true,
				Computed:            false,
			},
			"workflow_failed": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Workflow Failed\" event",
				Optional:            true,
				Computed:            false,
			},
			"workflow_started": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Workflow Started\" event",
				Optional:            true,
				Computed:            false,
			},
			"updates_detected": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Updates Detected\" event",
				Optional:            true,
				Computed:            false,
			},
			"collaborator_added": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Collaborator Added\" event",
				Optional:            true,
				Computed:            false,
			},
			"action_failed": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Action Failed\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_ending_failed": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Ending Failed\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_ended": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Ended\" event",
				Optional:            true,
				Computed:            false,
			},
			"environment_active_with_error": schema.BoolAttribute{
				MarkdownDescription: "Confgure notification for the \"Environment Active With Error\" event",
				Optional:            true,
				Computed:            false,
			},
			...
			"end_threshold": schema.Int64Attribute{
				MarkdownDescription: "Confgure notification environment end reminder notification",
				Optional:            true,
				Computed:            false,
			},
			"idle_reminders": schema.ListAttribute{
				MarkdownDescription: "Confgure notification for environment reminder notification",
				Optional:            true,
				Computed:            false,
